    ...
    <div class="main-container container-fluid">
          ...
          <div class="col-12 col-sm-12">
              <div class="card ">
                <div class="card-header">
                    <h3 class="card-title mb-0">Add Farm Details</h3>
                </div>
                <div class="card-body">
        ...
        <div class="row">
          <div class="col-12 col-sm-12">
              <div class="card ">
                <div class="card-header">
                    <h3 class="card-title mb-0">All Farms Details </h3>
                </div>
                <div class="card-body">
                                    ...
                                    <tbody>
                                      @foreach($shade AS $s)
                                        <tr>
                                            ...
                                            <td><span
                                                class="waves-effect waves-light btn btn-rounded btn-danger-light">{{ $s->name ?? '' }}</span>
                                            </td>
                                            <td><span
                                                class="waves-effect waves-light btn btn-rounded btn-success-light">{{ $s->address }}</span>
                                            </td>
                                            <td>{{ $s->status }}</td>
