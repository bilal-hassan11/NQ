    ...
    <div class="main-container container-fluid">
                        ...
                        <form action="{{ route('admin.expenses.expensestore') }}" class="ajaxForm" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 ">
                                    ...
                                    <select class="form-control select2" name="shade" id="shade_id">
                                        ...
                                        @foreach($shade as $s)
                                        <option  value="{{ $s->id }}"  {{ $s->id == @$edit_expense->shade_id ? 'selected' : '' }}>{{ $s->name }}</option>
                                        @endforeach
                                    </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="submit" value="{{ (isset($is_update) ? 'Update' : 'Save') }}" class="btn btn-primary mt-2 " >
                                </div>
                            </div>
                        </form>
                      <br /><br />
        ...
        <div class="row">
          <div class="col-12 col-sm-12">
              <div class="card ">
                <div class="card-header">
                    <h3 class="page-title mb-0" >All Expenses Detail </h3>
                </div>
                <div class="card-body">
                                ...
                                <table id="example54" class="table table-bordered text-nowrap mb-0 dataTable no-footer" role="grid" aria-describedby="data-table_info">
                                    ...
                                    @foreach($expenses AS $ex)
                                            <tr>
                                                ...
                                                <td><span class="waves-effect waves-light btn btn-info-light">{{ @$ex->shade->name }}</span></td>
                                                ...
                                                <td><span class="waves-effect waves-light btn btn-warning-light">{{ @$ex->remarks }}</span></td>
                                                <td width="120">
                                                    <div class="btn-list">
