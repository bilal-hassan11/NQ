                    ...
                    <td class="product_col">
                        <select class="form-control product product_val" name="item_id[]" required>
                            ...
                            @endforeach
                               ...
                               <td class="weight_col">
                        <input type="number" name="weight[]" class="form-control weight text-right" min="0" value="${item.weight || 0}" step="any" style="text-align: right;" required>
                    </td>
                    <td class="weight_detection_col">
                        <input type="number" name="weight_detection[]" class="form-control weight_detection text-right" min="0" value="${item.weight_detection || 1}" step="any" style="text-align: right;" required>
                    </td>
                    <td class="quantity_col">
                        <input type="number" name="quantity[]" class="form-control quantity text-right" min="0" value="${item.quantity || 0}" step="any" style="text-align: right;" readonly required>
                    </td>
                    <td class="purchase_rate_col">
                        <input type="number" name="purchase_price[]" class="form-control purchaseRate text-right" value="${item.sale_price || 0}" step="any" style="text-align: right;" required>
